...
graph TD;
    ...
    %% Networking & Routing
    A1[Traefik Reverse Proxy] -->|Routes Traffic| B1[Docker and Kubernetes]
    A2[WireGuard VPN] -->|Secures Access| A1
    A3[Bird and BGPalerter] -->|Monitors Network| A1

    %% Security & Authentication
    S1[Keycloak SSO and RBAC] -->|Authenticates Users| A1
    S2[Vaultwarden Secrets Management] -->|Stores Secrets| S1

    %% Infrastructure & Compute
    B1 -->|Manages VMs and Containers| B2[Proxmox VE]
    B1 -->|Manages Containers| B3[Portainer]
    
    %% Storage & Backup
    B4[Nextcloud File Sharing] -->|Stores Data| B5[Restic and BorgBackup]
    ...
    C2 -->|Triggers Builds| C3[Drone CI Automation]
